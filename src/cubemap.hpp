...
public:
	...
	uint32_t irradianceMap, envCubemap;
	Camera& camera;
...
private:
	uint32_t m_cubeVBO, m_cubeVAO, m_hdri;
	uint32_t m_captureFBO, m_captureRBO, m_irradianceFBO, m_irradianceRBO;
	void initCubemapCaptureFBO();
	void initIrradianceCaptureFBO();
	void renderCube();
