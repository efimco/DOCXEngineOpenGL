...
{
	const std::string vBackgroundShader =
		std::filesystem::absolute("..\\..\\src\\shaders\\cubemap\\background.vert").string();
	const std::string fBackgroundShader =
		std::filesystem::absolute("..\\..\\src\\shaders\\cubemap\\background.frag").string();

	const std::string vEqrToCubemapShader =
		std::filesystem::absolute("..\\..\\src\\shaders\\cubemap\\equirectangularToCubemap.vert").string();
	const std::string fEqrToCubemapShader =
		std::filesystem::absolute("..\\..\\src\\shaders\\cubemap\\equirectangularToCubemap.frag").string();

	const std::string vIrradianceConvolutionShader =
		std::filesystem::absolute("..\\..\\src\\shaders\\cubemap\\equirectangularToCubemap.vert").string();
	const std::string fIrradianceConvolutionShader =
		std::filesystem::absolute("..\\..\\src\\shaders\\cubemap\\irradianceConvolution.frag").string();

	const std::string vSpecularConvolutionShader =
		std::filesystem::absolute("..\\..\\src\\shaders\\cubemap\\equirectangularToCubemap.vert").string();
	const std::string fSpecularConvolutionShader =
		std::filesystem::absolute("..\\..\\src\\shaders\\cubemap\\specularConvolution.frag").string();
